...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, line):
        """Here creates a new instance of BaseModel, saves it
        Exceptions:
    ...
    def do_all(self, line):
        """will Print all string representation of all instances
        Exceptions:
            NameError: when there is no object taht has the name
        """
        objects = storage.all()
    ...
    def strip_clean(self, args):
        """will strip the argument and return string of command
        Args:
    ...
    def default(self, line):
        """will retrieve all the instances of a class and
