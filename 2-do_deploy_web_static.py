#!/usr/bin/python3
"""a script to pack the static content into a tarball
"""
...
def do_pack():
    """it packages all contents from web_static into .tgz archive
    """
...
def do_deploy(archive_path):
    """This will deploy a static archive to web servers
    """
